...
namespace CS4760_Project.Pages.FinancialRequests
{
    public class OtherModel : PageModel
    {
        ...
        public void OnGet()
        {
            string sessionData = HttpContext.Session.GetString("Other");
        ...
        public IActionResult OnPost()
        {
            ...
            FinancialRequest.RequestType = "Other";
            FinancialRequest.GrantType = "RSPG";

            FinancialRequests.Add(FinancialRequest);

            // Save back to session
            HttpContext.Session.SetString("Other", JsonConvert.SerializeObject(FinancialRequests));
            HttpContext.Session.SetString("TempId", JsonConvert.SerializeObject(TempId));

            return RedirectToPage("/FinancialRequests/Other");
        }
