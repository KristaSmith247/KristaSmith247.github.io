...
namespace CS4760_Project.Pages.FinancialRequests
{
    public class TravelModel : PageModel
    {
        ...
        public void OnGet()
        {
            string sessionData = HttpContext.Session.GetString("Travel");
        ...
        public IActionResult OnPost()
        {
            ...
            FinancialRequest.RequestType = "Travel";
            FinancialRequest.GrantType = "RSPG";

            FinancialRequests.Add(FinancialRequest);

            // Save back to session
            HttpContext.Session.SetString("Travel", JsonConvert.SerializeObject(FinancialRequests));
            HttpContext.Session.SetString("TempId", JsonConvert.SerializeObject(TempId));

            return RedirectToPage("/FinancialRequests/Travel");
        }
